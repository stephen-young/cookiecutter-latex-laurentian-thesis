...
\renewcommand{\cftloptitlefont}{\hfill\Large}
...
\setlength{\cftplatenumwidth}{1.8cm}
...
\renewcommand{\cftloatitlefont}{\hfill\Large}
...
\begin{figure}
    \centering
    \includegraphics[width=5cm]{laurentian-university-coa.png}
